    ...
    <div class="daohang">
        <nav>
            ...
            <li >
                ...
                <ul class="ul_item">
                    <li><a href="./intro.jsp">introducemyself</a></li>
                    <li><a href="./plan.jsp">myplan</a></li>
                </ul>
            </li>
            <li ><a href="./category.html">category</a>
                <ul class="ul_item">
                    <li><a href="./delicacy.jsp">delicacy</a></li>
                    <li><a href="./s&h.jsp">sports&health</a></li>
                    <li><a href="./entertain.jsp">entertainment</a></li>
                </ul>
            </li>
            <li ><a href="./blog.jsp">blog</a>
                <ul class="ul_item">
                    <li><a href="https://blog.csdn.net/m0_53941252?spm=1000.2115.3001.5343">mycsdn</a></li>
                    <li><a href="./Selected.jsp">Selected</a></li>
                    <li><a></a></li>
                </ul>
            </li>
            <li ><a href="./style.jsp">style</a>
                <ul class="ul_item">
                    <li><a></a></li>
                    <li>2</li>
                </ul>
            ...
            <li ><a href="./contact.jsp">contacts</a>
                <ul class="ul_item">
                    <li><a href="./moments.jsp">moments</a></li>
                    <li>2</li>
                </ul>
            </li>
        </ul>
